    ...
    <>
      {
        ...
        <div className="sm:static fixed top-0 left-0 h-full w-full sm:w-auto sm:fit bg-gray-500/50 sm:bg-transparent z-50" onClick={handleClose}>
          <div className="bg-white p-6 rounded-lg shadow-sm h-full w-fit " onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold">Filters</h2>
              <span className='flex flex-col gap-2 items-center'>
                <ChevronLeft className='bg-gray-200 rounded-full p-1 cursor-pointer sm:hidden' onClick={handleClose} />
                <button
                  onClick={onClearAll}
